...
!--------------------------------------------------------------------
! Partial runs, with selected output
!--------------------------------------------------------------------

subroutine mtspec_yk (npts,dt,x,tbp,kspec,df4,yk)
...
!  Eigenspectra
   ...
   real(8),    dimension(npts/2+1,kspec)        :: sk_o 
   complex(8), dimension(npts,kspec)        :: yk_o 

!  Simple mean spectra

   real(8), dimension(npts/2+1)     :: sbar
