subroutine qi_nsqi(npts,tbp,kspec,nf,lambda,vn,yk,wt,  &
                 qispec,qislope,nsspec,nsdiff,nsd2,    &
                 cte_var,slope_var,nscte_var,nsslope_var)
...
!  In/Out & Out
   ...
   real(8), dimension(nf),   intent(out)           :: qislope
